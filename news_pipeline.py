...
RULE_REGISTRY: Tuple[Tuple[str, str, str, float], ...] = (
    ...
    (r"\b(opinion|op-ed|i think|editorial)\b", "opinion", "NEUTRAL", 0.10),
    (r"\b(may|could|reportedly|rumou?r|speculation|unconfirmed|sources say)\b", "rumor", "NEUTRAL", 0.25),
    ...
    (r"\b(liquidation|liquidated)\b", "liquidation", "BEARISH", 0.70),
    (r"\b(will list|lists|listed|listing)\b", "listing", "BULLISH", 0.70),
    (r"\b(approv(ed|es|al)|etf approved)\b", "approval", "BULLISH", 0.80),
    (r"\b(partnership|integrat(es|ion)|launch)\b", "partnership", "BULLISH", 0.60),
